...
//Constantes Figuras
const long double arrPhi1[4]={0.3288777,0.2407369,0.2129118,0.1659098};
const long double arrPhi2[4]={0.074311,0.0107755,0.00208445,0.0006762};
const long double stdPhi1[4]={0.004461183,0.004096511,0.001561472,0.000245853};
const long double stdPhi2[4]={0.002389544,0.001390904,0.000564709,0.000099343};

bool izqDer = false, adeAtr = false;
int subBaj = 0;
//Variables drone
